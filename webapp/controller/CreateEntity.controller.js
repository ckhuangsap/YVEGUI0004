...
], function(BaseController, JSONModel, MessageBox, formatter, Filter, FilterOperator, History, Fragment  ) {
	"use strict";

	return BaseController.extend("YVEGUI0004.controller.CreateEntity", {
