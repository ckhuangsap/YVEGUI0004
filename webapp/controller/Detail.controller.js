/*global location */
sap.ui.define([
	"YVEGUI0004/controller/BaseController",
	"sap/ui/model/json/JSONModel",
	"YVEGUI0004/model/formatter",
	"sap/m/MessageBox",
	"sap/m/MessageToast"
	...
	return BaseController.extend("YVEGUI0004.controller.Detail", {
		...
		onInit: function() {
			...
			//oViewModel.setProperty("/Source","/sap/opu/odata/SAP/YVEGUI0004_SRV_01/PDFSet('1')/$value");
		},
		...
		//	sObjectHeader = this.oOdataModel.getProperty(sPath + "/Guino");
		...
		//	var oViewModel = this.getModel("detailView");
			var oPath = "/sap/opu/odata/SAP/YVEGUI0004_SRV_01/PDFSet('" + sObjectHeader +"')/$value";
